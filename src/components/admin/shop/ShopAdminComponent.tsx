...
const ShopAdminComponent = () => {
  ...
  const url = `${process.env.SERVER_ENDPOINT}/api/admin/shops?page=${currentPage}&status=${statusFilter}`;
  const {
    data: productsItems,
    isLoading,
    isValidating,
            ...
            <div className="w-full overflow-x-auto">
              <table className="w-full whitespace-nowrap">
                ...
                <tbody className="bg-white divide-y divide-gray-100 dark:divide-gray-700 dark:bg-gray-800 text-gray-800 dark:text-gray-400">
                  {productsItems ? (
                    productsItems.data.map((item: ShopData, index: number) => (
...
export default ShopAdminComponent;
