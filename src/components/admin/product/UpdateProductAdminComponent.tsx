...
const UpdateProductAdminComponent: React.FC<ModalProps> = ({
  openModal,
  isOpen,
  closeModal,
  itemProducts,
  ...
  */
  ...
  const url = `${process.env.SERVER_ENDPOINT}/api/admin/product/suppliers/${product.supplier.user_id}`;
  ...
  const filteredSuppliers = suppliers?.filter(
    (item: any) => item.user_id === product.supplier.user_id
  );
        ...
        <div className="drawer-content-wrapper w-5/6 relative z-50">
          <div className="drawer-content">
            <button
              ...
              className="fixed top-16 focus:outline-none z-30 text-red-500 hover:bg-red-100 hover:text-gray-700 transition-colors duration-150 bg-white shadow-md mr-6 mt-6 right-0 left-auto w-10 h-10 rounded-full block text-center"
            >
              <svg
                stroke="currentColor"
                fill="none"
                      ...
                      <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                        ...
                        <div className="col-span-8 sm:col-span-4">
                          <textarea
                            ...
                            className="block bg-gray-100 focus:bg-white dark:text-gray-300 rounded-md focus:outline-none p-3 border dark:border-gray-600 dark:focus:border-gray-600 dark:bg-gray-700 text-sm  w-full  border-gray-200"
                            name="description"
                        ...
                        <div className="col-span-8 sm:col-span-4">
                          <div className="flex flex-row">
                            ...
                            <CurrencyInput
                              ...
                              value={salePrice}
                              className="block w-full h-12 px-3 py-1 text-sm focus:outline-none dark:text-gray-300 leading-5 rounded-md focus:bg-white dark:focus:bg-gray-700 border border-gray-400 opacity-50 bg-gray-300 dark:bg-gray-800 mr-2 p-2 rounded-l-none"
                              // intlConfig={{ locale: "id", currency: "IDR" }}
                            />
                            {/* <input
...
export default UpdateProductAdminComponent;
