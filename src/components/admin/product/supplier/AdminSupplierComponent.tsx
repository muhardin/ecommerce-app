...
const AdminSupplierComponent = () => {
  ...
  const url = `${process.env.SERVER_ENDPOINT}/api/admin/product/suppliers-data?page=${currentPage}&status=${statusFilter}`;
  const {
    data: productsItems,
    isLoading,
    isValidating,
    ...
    <>
      ...
      <main className="h-full overflow-y-auto">
        ...
        <div className="sm:container grid lg:px-6 sm:px-4 px-2 mx-auto">
          <h1 className="my-6 text-sm font-bold text-gray-700 dark:text-gray-300 ">
            ...
            <div className="w-full overflow-x-auto">
              <table className="w-full whitespace-nowrap">
                ...
                <tbody className="bg-white divide-y divide-gray-100 dark:divide-gray-700 dark:bg-gray-800 text-gray-800 dark:text-gray-400">
                  {productsItems ? (
                    productsItems.data.map(
                      (item: SupplierData, index: number) => (
                        <tr className="" key={item.id}>
                          ...
                          <td className="px-4 py-2">
                            <label
                              htmlFor={`654a3c8d73ddc60007066f53${item.id}`}
                            >
                          ...
                          <td className="px-4 py-2">
                            <div className="flex flex-col justify-start">
                              {item.shop_package?.package_name}
                            </div>
                          </td>
                          <td className="px-4 py-2">
...
export default AdminSupplierComponent;
