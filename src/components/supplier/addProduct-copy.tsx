              ...
              <table className="w-full whitespace-nowrap">
                ...
                <tbody className="bg-white divide-y divide-gray-100 dark:divide-gray-700 dark:bg-gray-800 text-gray-800 dark:text-gray-400">
                  <tr className="">
                      ...
                      <div className="flex items-center">
                        <div className="relative rounded-full inline-block w-8 h-8 hidden p-1 mr-2 md:block bg-gray-50 shadow-none">
                          <img
                            ...
                            src="https://res.cloudinary.com/ahossain/image/upload/v1699363889/product/VN20230527_112429_Moment%282%29.jpg"
                            alt="product"
                            loading="lazy"
                          />
                          <div
                    ...
                    <td className="px-4 py-2">
                      <span className="text-sm font-semibold">$300.00</span>
                    </td>
                    <td className="px-4 py-2">
                    ...
                    <td className="px-4 py-2 text-center">
                      <div className="relative inline-block text-left opacity-100 border rounded-lg transition-opacity duration-250 ease-in-out select-none touch-none tap-highlight-transparent">
                        <div className="relative h-15 w-30 m-0 bg-green-500 rounded-7.5 cursor-pointer transition-background duration-250 ease-in-out">
                          <div className="h-15 w-17 relative opacity-100 pointer-events-none transition-opacity duration-250 ease-in-out">
                            <div className="flex justify-center items-center w-73 h-full text-white text-14 pl-20 pt-1"></div>
                          </div>
                          <div className="h-15 w-17 absolute opacity-0 right-0 top-0 pointer-events-none transition-opacity duration-250 ease-in-out">
                            <div className="flex items-center h-full w-120 text-white text-14 pr-22 pt-1"></div>
                          </div>
                        </div>
                        <div className="h-13 w-13 bg-white inline-block cursor-pointer rounded-full absolute translate-x-16 top-1 focus:outline-none focus:border-0 transition-all duration-250 ease-in-out"></div>
                        <input
                          type="checkbox"
                          role="switch"
                          aria-checked="true"
                          checked
                          className="border-0 w-1 h-1 m--1 overflow-hidden absolute"
                        />
                      </div>
                    </td>
                    <td className="px-4 py-2">
                  ...
                  <tr className="">
                    ...
                    <td className="px-4 py-2">
                      <span className="text-sm">Rui</span>
                    </td>
                    <td className="px-4 py-2">
                    ...
                    <td className="px-4 py-2">
                      <span className="text-sm">4690</span>
                    </td>
                    <td className="px-4 py-2">
                      <span className="inline-flex px-2 text-xs font-medium leading-5 rounded-full text-emerald-600 bg-emerald-100 dark:bg-emerald-800 dark:text-emerald-100">
                        Selling
                    ...
                    <td className="px-4 py-2">
                      <a
                        className="flex justify-center text-gray-400 hover:text-emerald-600"
                        href="/product/654a0fbdcab9d70008317da6"
                      >
                        <p data-tip="true" data-for="view" className="text-xl">
                          <svg
                            stroke="currentColor"
                    ...
                    <td className="px-4 py-2 text-center">
                      <div className="relative inline-block text-left opacity-100 direction-ltr border rounded-lg transition-opacity duration-250 ease-in-out touch-none tap-highlight-transparent select-none">
                        <div className="h-15 w-30 m-0 relative bg-green-500 rounded-7.5 cursor-pointer transition-background duration-250 ease-in-out">
                          <div className="h-15 w-17 relative opacity-100 pointer-events-none transition-opacity duration-250 ease-in-out">
                            <div className="flex justify-center items-center w-73 h-full text-white text-14 pl-20 pt-1"></div>
                          </div>
                          <div className="h-15 w-17 absolute opacity-0 right-0 top-0 pointer-events-none transition-opacity duration-250 ease-in-out">
                        ...
                        <div className="h-13 w-13 bg-white inline-block cursor-pointer rounded-full absolute translate-x-16 top-1 focus:outline-none focus:border-0 transition duration-250 ease-in-out"></div>
                        <input
                          type="checkbox"
                          role="switch"
                          aria-checked="true"
                  ...
                  <tr className="">
                    <td className="px-4 py-2">
                      <input
                        id="654a0debc14cfe0006168d03"
                        name=" as dsadsadasdas"
                        type="checkbox"
                      />
                    </td>
                    <td className="px-4 py-2">
                      <div className="flex items-center">
                        <div className="relative rounded-full inline-block w-8 h-8 hidden p-1 mr-2 md:block bg-gray-50 shadow-none">
                          <img
                            className="object-cover w-full h-full rounded-full"
                            src="https://res.cloudinary.com/ahossain/image/upload/v1699351847/product/image4.jpg"
                            alt="product"
                            loading="lazy"
                          />
                          <div
                    ...
                    <td className="px-4 py-2">
                      <a
                        className="flex justify-center text-gray-400 hover:text-emerald-600"
                        href="/product/654a0debc14cfe0006168d03"
                      >
                        <p data-tip="true" data-for="view" className="text-xl">
                          <svg
                            stroke="currentColor"
                    ...
                    <td className="px-4 py-2 text-center">
                      <div className="relative inline-block text-left opacity-100 direction-ltr rounded-lg transition-opacity duration-250 ease-in-out touch-none select-none">
                        <div className="h-15 w-30 m-0 relative bg-green-500 rounded-7.5 cursor-pointer transition-background duration-250 ease-in-out">
                          <div className="h-15 w-17 relative opacity-100 pointer-events-none transition-opacity duration-250 ease-in-out">
                            <div className="flex justify-center items-center w-73 h-full text-white text-14 pl-20 pt-1"></div>
                          </div>
                        ...
                        <input
                          ...
                          aria-checked="true"
                          checked
                          className="border-0 clip-rect-0 h-1 w-1 m--1 overflow-hidden absolute"
                        />
                      </div>
                    </td>
                    <td className="px-4 py-2">
                  ...
                  <tr className="">
                    ...
                    <td className="px-4 py-2">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h2 className="text-sm font-medium ">nhnyhyhyh</h2>
                        </div>
                      </div>
                    </td>
                    <td className="px-4 py-2">
                    ...
                    <td className="px-4 py-2">
                      <span className="text-sm font-semibold">$666.00</span>
                    </td>
                    <td className="px-4 py-2">
                      <span className="text-sm font-semibold">$555.00</span>
                    </td>
                    <td className="px-4 py-2">
                    ...
                    <td className="px-4 py-2">
                      <a
                        className="flex justify-center text-gray-400 hover:text-emerald-600"
                        href="/product/6548e18b0ff4730008cde823"
                      >
                        <p data-tip="true" data-for="view" className="text-xl">
                          <svg
                            stroke="currentColor"
                    ...
                    <td className="px-4 py-2 text-center">
                      <div className="react-switch md:ml-0 relative inline-block text-left opacity-100 direction-ltr rounded-7.5 transition-opacity duration-250 ease-in-out touch-none select-none">
                        <div className="react-switch-bg h-15 w-30 m-0 relative bg-green-500 rounded-7.5 cursor-pointer transition-background duration-250 ease-in-out">
                          <div className="h-15 w-17 relative opacity-100 pointer-events-none transition-opacity duration-250 ease-in-out">
                            <div className="flex justify-center items-center w-73 h-full text-white text-14 pl-20 pt-1"></div>
                          </div>
                          <div className="h-15 w-17 absolute opacity-0 right-0 top-0 pointer-events-none transition-opacity duration-250 ease-in-out">
                        ...
                        <div className="react-switch-handle h-13 w-13 bg-white inline-block cursor-pointer rounded-full absolute translate-x-16 top-1 focus:outline-none focus:border-0 transition-all duration-250 ease-in-out"></div>
                        <input
                          type="checkbox"
                          role="switch"
                          aria-checked="true"
                  ...
                  <tr className="">
                    ...
                    <td className="px-4 py-2">
                      <div className="flex items-center">
                        <div className="relative rounded-full inline-block w-8 h-8 hidden p-1 mr-2 md:block bg-gray-50 shadow-none">
                          <img
                            className="object-cover w-full h-full rounded-full"
                            src="https://res.cloudinary.com/ahossain/image/upload/v1699244500/product/laptop-img.jpg"
                            alt="product"
                            loading="lazy"
                          />
                          <div
                        ...
                        <div>
                          <h2 className="text-sm font-medium ">Redmi note 9</h2>
                        </div>
                      </div>
                    </td>
                    <td className="px-4 py-2">
                      <span className="text-sm">Tuna</span>
                    </td>
                    <td className="px-4 py-2">
                    ...
                    <td className="px-4 py-2">
                      <a
                        className="flex justify-center text-gray-400 hover:text-emerald-600"
                        href="/product/65486a43c7639c0008e4bb11"
                      >
                        <p data-tip="true" data-for="view" className="text-xl">
                          <svg
                            stroke="currentColor"
                  ...
                  <tr className="">
                    ...
                    <td className="px-4 py-2">
                      <div className="flex items-center">
                        <div className="relative rounded-full inline-block w-8 h-8 hidden p-1 mr-2 md:block bg-gray-50 shadow-none">
                          <img
                            className="object-cover w-full h-full rounded-full"
                            src="https://res.cloudinary.com/ahossain/image/upload/v1699243671/product/baby2.jpg"
                            alt="product"
                            loading="lazy"
                          />
                          <div
                    ...
                    <td className="px-4 py-2">
                      <a
                        className="flex justify-center text-gray-400 hover:text-emerald-600"
                        href="/product/654866c05653660008ef1497"
                      >
                        <p data-tip="true" data-for="view" className="text-xl">
                          <svg
                            stroke="currentColor"
