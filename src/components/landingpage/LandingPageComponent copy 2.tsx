          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
              <h2 className="text-3xl font-medium tracking-tight text-white">
                Every feature you need to start your business. Try it for
                yourself.
              </h2>
                  ...
                  <div className="absolute left-[calc(23/366*100%)] top-[calc(23/729*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-gray-900 pt-[calc(23/318*100%)]">
                    ...
                    >
                      <div className="flex flex-col w-full">
                        ...
                        <div className="mt-6 px-4 text-white opacity-100">
                          <div className="text-2xl text-white">
                            Invite people
                          </div>
                          <div className="text-sm text-gray-500">
                        ...
                        <div className="mt-6 flex-auto rounded-t-2xl bg-white opacity-100 z-1073741824 filter blur-0 transform translate-y-0 scale-100 translate-z-0">
                          <div className="px-4 py-6">
                            <div className="space-y-6">
                              <div>
                                <div className="text-sm text-gray-500">
