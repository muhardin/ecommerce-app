            ...
            <div className="banner-card xl:flex xl:space-x-[30px] xl:h-[600px] mb-[30px]">
              <div
                ...
                <picture>
                  <source
                    ...
                    srcSet="/images/theme/one/slide/banner-1.png"
                  />
                  <img
                    src="/images/theme/one/slide/banner-1.2.png"
                    alt=""
              ...
              <div
                ...
                <div className="w-full xl:h-1/2">
                  <img
                    src="/images/theme/one/slide/banner-2.png"
                    alt=""
                ...
                <div className="w-full xl:h-1/2">
                  <img
                    src="/images/theme/one/slide/banner-3.png"
                    alt=""
                    className="w-full h-full"
                  />
                </div>
