...
const CheckoutCart = () => {
  ...
  const handleSelectChange = (
    ...
    const cost = [];
    cost[selectId] = getCourierCost?.rajaongkir?.results[0]?.costs; // Update the selected value at the specified index
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row gap-2">
                ...
                <div className="" key={item.id}>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 p-4 justify-end">
                    ...
                    <div className="">
                      ...
                      >
                        {costs?.map((co: any) => (
                          <option key={co.service} value="US">
                            <div className="flex flex-row justify-between w-full gap-4">
                              <span>{co.description}</span>
                              <span> | </span>
                              <span>{co.cost[0].etd} days</span>
                              <span> | </span>
                              <span>
                                <FormattedPrice amount={co.cost[0].value} />
                              </span>
                            </div>
                          </option>
                        ))}
        ...
        <div className="border border-gray-200 bg-white w-full md:w-1/3 md:fixed md:right-0">
          <PaymentForm />
        </div>
      </div>

      <div
        className={`relative z-10 ${modal ? "visible" : "invisible"} h-screen`}
