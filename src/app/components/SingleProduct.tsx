...
const SingleProduct = ({ product, primaryImage }: any) => {
  ...
  return (
    ...
    //           <div className="relative mb-2 lg:mb-10 h-[450px] rounded-lg">
    //             <Image
    //               width={250}
    //               height={250}
    //               src="https://img.freepik.com/free-photo/portrait-beautiful-face-young-woman-with-long-brown-hair_186202-4331.jpg?size=626&ext=jpg&ga=GA1.1.453157835.1694346094&semt=sph"
    //               alt=""
