    ...
    <div>
      ...
      >
        <motion.div
          ...
          animate={controls as AnimationControls} // Cast to AnimationControls
          transition={{ duration: 0.5 }}
          id="speed-dial-menu-default"
          className={`${
            isHovered == false ? "hidden" : ""
        ...
        <button
          ...
          className={`flex items-center justify-center text-white bg-gradient-to-r from-sky-600 to-cyan-400 rounded-full w-14 h-14 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800`}
        >
          <svg
