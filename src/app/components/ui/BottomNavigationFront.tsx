      ...
      <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        <Link
          ...
          <svg
            ...
            className="lucide lucide-shopping-bag text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">
        ...
        <div className=" flex items-center justify-center">
          <Link
            ...
            className="relative inline-flex items-center justify-center w-10 h-10 font-medium bg-blue-600 rounded-full hover:bg-blue-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
            ...
            {productData.length > 0 ? (
              <button className="absolute -top-1 p-1 -right-2 w-6 h-6 bg-red-600 rounded-full text-xs flex flex-row items-center justify-center text-white">
...
export default BottomNavigationFront;
